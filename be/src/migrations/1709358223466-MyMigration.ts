...
export class MyMigration1709358223466 implements MigrationInterface {
    name = 'MyMigration1709358223466'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "full_name" character varying NOT NULL, "email" character varying, "password" character varying, "bio" character varying, "photo_profile" character varying, "photo_background" character varying, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
